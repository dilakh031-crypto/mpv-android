...
internal class MPVView(context: Context, attrs: AttributeSet) : BaseMPVView(context, attrs) {
    ...
    override fun observeProperties() {
        ...
        val p = arrayOf(
            ...
            Property("contrast", MPV_FORMAT_INT64),
            Property("brightness", MPV_FORMAT_INT64),
            Property("gamma", MPV_FORMAT_INT64),
            Property("saturation", MPV_FORMAT_INT64),
            Property("audio-delay", MPV_FORMAT_DOUBLE),
            Property("sub-delay", MPV_FORMAT_DOUBLE),
            Property("secondary-sub-delay", MPV_FORMAT_DOUBLE),
